...
export const APP_CONFIG = {
  SHEET_ID: '1SYaPsMFc4sh1qe4AvGT0nXNNBdQvFxrTXv0MthHpsIE',
  // 注意：此處 URL 應與 App.tsx 中使用的 API 位址保持一致
  SCRIPT_URL: 'https://script.google.com/macros/s/AKfycbwUSwBd5wLe206LugAjngSdmuADnxz6tEJu-U1HrXjbV1Ykev85Q56bIynEtEtcJwc/exec',
